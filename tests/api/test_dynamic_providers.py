...
class TestDynamicProviderRegistration:
    ...
    def test_unregister_provider(self):
        ...
        # Register provider
        register_provider(
            name="unregister_test", api_base="https://test.com/v1", models=["model1"]
        )
    ...
    def test_api_key_storage(self):
        ...
        provider = register_provider(
            name="key_test", api_key="secret-key-123", models=["model1"]
        )
    ...
    def test_api_key_env_variable(self):
        ...
        register_provider(
            name="env_key_test", api_key_env="TEST_API_KEY", models=["model1"]
        )
    ...
    def test_duplicate_registration_overwrites(self):
        ...
        # Register initial
        register_provider(
            name="duplicate_test", api_base="https://first.com/v1", models=["model1"]
        )
...
class TestOpenAICompatibleRegistration:
    ...
    def test_register_with_api_base_env(self):
        ...
        provider = register_openai_compatible(
            name="openai_test2", api_base_env="CUSTOM_ENDPOINT", models=["model1"]
        )
    ...
    def test_default_models(self):
        ...
        provider = register_openai_compatible(
            name="openai_test4", api_base="https://test.api.com/v1"
        )
        ...
        assert (
            ...
            or provider.extra.get("default_model") == "gpt-3.5-turbo"
        )

    def test_features_added(self):
        """Test that OpenAI features are added."""
        provider = register_openai_compatible(
            name="openai_test5", api_base="https://test.api.com/v1"
        )
...
class TestDynamicProviderIntegration:
    ...
    def test_dynamic_provider_with_client(self):
        ...
        with patch(
            ...
            # Create client
            get_client("dynamic_client_test")
    ...
    def test_persistence_across_operations(self):
        ...
        # Update it
        update_provider("persist_test", models=["model1", "model2"])
