...
async def main():
    ...
    if args.demo:
        demo_map = {
            ...
            10: ("Audio Input", demo_audio_input(client, "deepseek", args.model)),
            11: ("Parameters", demo_parameters(client, "deepseek", args.model)),
            12: ("Model Comparison", demo_model_comparison("deepseek", ['deepseek-chat', 'deepseek-reasoner'])),
            13: ("Dynamic Model Call", demo_dynamic_model_call("deepseek")),
            14: ("Error Handling", demo_error_handling(client, "deepseek", args.model)),
        }
