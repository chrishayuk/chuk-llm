...
async def test_real_world_examples():
    ...
    try:
        print(f"   🌊 Streaming response from qwen3:")
...
async def show_available_models():
    ...
    try:
        ...
        print(f"   🔧 Static models: {len([m for m in provider.models if m in ['llama3.3', 'qwen3', 'granite3.3', 'mistral', 'gemma3', 'phi3', 'codellama']])}")
...
async def main():
    ...
    print(f"💡 Your ChukLLM discovery system is fully operational")
    print(f"🚀 You now have access to 48 Ollama models with intelligent capabilities")
    
    print(f"\n📖 Quick Usage Guide:")
    print(f"   • Code: chuk_llm.ask('Write code', model='devstral')")
    print(f"   • Math: chuk_llm.ask('Calculate', model='qwen3:32b')")  
    print(f"   • Creative: chuk_llm.ask('Write story', model='llama3.3')")
    print(f"   • Technical: chuk_llm.ask('Explain', model='granite3.3')")
