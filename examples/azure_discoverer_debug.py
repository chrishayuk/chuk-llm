            ...
            async with httpx.AsyncClient(timeout=30.0) as client:
                ...
                if response.status_code == 200:
                    ...
                    for alt_url in alternatives:
                        print(f"\n🔄 Trying: {alt_url}")
                        try:
                            alt_response = await client.get(alt_url, headers=headers, params=params)
                            ...
                            if alt_response.status_code == 200:
                                ...
                                try:
                                    ...
                                    print(f"   📄 Response length: {len(alt_response.text)}")
                            else:
...
async def main():
    ...
    print(f"\n📋 Debug Summary:")
    print(f"   • Azure endpoint format appears to be correct")
    print(f"   • The /openai/models endpoint may not exist in your Azure OpenAI instance")
    ...
    print(f"   1. Azure OpenAI may not support the /openai/models listing endpoint")
    print(f"   2. Your Azure OpenAI resource may be configured differently")  
    print(f"   3. The API version may not support model listing")
    print(f"   4. This might be an older Azure OpenAI instance")
