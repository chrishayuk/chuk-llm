...
async def vision_example(model: str = "gpt-4o"):
    ...
    if not config.supports_feature("openai", Feature.VISION, model):
        ...
        print("💡 Try a vision-capable model like: gpt-4o, gpt-4-turbo, gpt-4")
        return None
...
async def reasoning_example(model: str = "o3-mini"):
    ...
    if not config.supports_feature("openai", Feature.REASONING, model):
        ...
        print("💡 Try a reasoning model like: o3, o3-mini, o1, o1-mini")
        return None
...
async def main():
    ...
    try:
        ...
        supports_reasoning = config.supports_feature(
            "openai", Feature.REASONING, args.model
        )
        supports_streaming = config.supports_feature(
            "openai", Feature.STREAMING, args.model
        )
    ...
    if successful == total:
        ...
        print("🔗 OpenAI/GPT provider is working perfectly with chuk-llm!")
        ...
        print("   • For general use: gpt-4o-mini, gpt-4o")
        print("   • For vision: gpt-4o, gpt-4-turbo")
        print("   • For reasoning: o3-mini, o3, o1-mini")
        print("   • For cost-effective: gpt-4o-mini, gpt-3.5-turbo")
