...
class ProviderResult:
    ...
    function_call: bool | None = None
    streaming_function_call: bool | None = None
    ...
    def record(self, capability: str, result: bool | None) -> None:
    ...
    def get_capability_status(self, capability: str) -> bool | None:
    ...
    def get_fastest_capability(self) -> str | None:
    ...
    def get_slowest_capability(self) -> str | None:
    ...
    def get_error_summary(self) -> str:
        ...
        error_types = []
        for _stage, error in self.errors.items():
    ...
    def __str__(self) -> str:
        ...
        return (
            f"ProviderResult({self.provider}, "
...
class DiagnosticSummary:
    ...
    def successful_providers(self) -> list[str]:
        ...
        return [
            ...
            if not r.has_errors() and r.success_rate >= 0.75
        ]
    ...
    def problematic_providers(self) -> list[str]:
        ...
        return [
            r.provider for r in self.results if r.has_errors() or r.success_rate < 0.5
        ]
    ...
    def get_capability_matrix(self) -> dict[str, dict[str, bool | None]]:
