...
def main():
    ...
    try:
        ...
        test_results["discovery_disabled"] = test_chuk_llm_import(
            "Discovery Disabled", tracker
        )
        ...
        test_results["safe_discovery_functions"] = test_discovery_functions(
            "Safe Discovery Functions"
        )
        ...
        test_results["aggressive_discovery"] = test_chuk_llm_import(
            "Aggressive Discovery", tracker
        )
        test_results["aggressive_discovery_functions"] = test_discovery_functions(
