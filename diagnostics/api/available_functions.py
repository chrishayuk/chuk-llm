...
def main():
    ...
    try:
        ...
        from chuk_llm.api.providers import list_provider_functions, get_all_functions
        ...
        print(f"📊 Functions by Provider:")
        for provider in sorted(providers):
            provider_funcs = [f for f in sync_functions if f.startswith(f'ask_{provider}_')]
