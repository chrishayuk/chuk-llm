...
try:
    ...
    print(f"chuk_llm attributes: {[attr for attr in dir(chuk_llm) if not attr.startswith('_')][:20]}...")
...
try:
    ...
    provider_funcs = [attr for attr in dir(providers) if attr.startswith(('ask_', 'stream_'))]
