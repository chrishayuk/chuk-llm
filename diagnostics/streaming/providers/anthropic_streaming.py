...
async def test_anthropic_vs_openai():
    ...
    if all(results.values()):
        ...
        if anthropic_result["chunks"] > openai_result["chunks"]:
            print(f"   📊 Anthropic more granular streaming ({anthropic_result['chunks']} vs {openai_result['chunks']} chunks)")
        else:
            print(f"   📊 OpenAI more granular streaming ({openai_result['chunks']} vs {anthropic_result['chunks']} chunks)")
