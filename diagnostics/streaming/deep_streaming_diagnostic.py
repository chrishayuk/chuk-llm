...
async def test_client_directly():
    ...
    messages = [
        ...
        {
            "role": "user",
            "content": "Tell me a short story about a cat. Take your time and make it detailed.",
        },
    ]
    ...
    try:
        ...
        response_stream = client.create_completion(messages=messages, stream=True)
...
async def test_comparison():
    ...
    try:
        ...
        print(
            f"   chuk-llm: {chuk_chunks} chunks, first at {chuk_first_chunk:.3f}s, total {chuk_total:.3f}s"
        )
    ...
    try:
        ...
        print(
            f"   Raw OpenAI: {raw_chunks} chunks, first at {raw_first_chunk:.3f}s, total {raw_total:.3f}s"
        )
