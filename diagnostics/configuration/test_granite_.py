...
def debug_granite_function():
    ...
    try:
        ...
        granite_models = [
            model for model in provider.models if "granite" in model.lower()
        ]

        print("   Granite models in config:")
    ...
    try:
        ...
        new_functions = _generate_functions_for_models(
            "ollama", provider, granite_models
        )

        granite_funcs = {
            name: func for name, func in new_functions.items() if "granite" in name
        }

        print("   Generated granite functions:")
        ...
        if "ask_ollama_granite3_3_latest" in granite_funcs:
            print("   ✅ ask_ollama_granite3_3_latest was generated!")
        else:
            print("   ❌ ask_ollama_granite3_3_latest was NOT generated")
