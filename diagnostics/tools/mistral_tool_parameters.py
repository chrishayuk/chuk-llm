...
async def test_mistral_vs_anthropic_consistency():
    ...
    try:
                ...
                if func_name == "stdio.describe_table":
                    ...
                    try:
                        ...
                        if "table_name" in parsed_args and parsed_args["table_name"]:
                            print(
                                f"   ✅ Parameter extraction worked: table_name='{parsed_args['table_name']}'"
                            )
                            results[provider] = {
                                "success": True,
                                "tool_name": func_name,
        ...
        if mistral_result.get("success") and anthropic_result.get("success"):
            print("   ✅ Both providers successful")
            ...
            print(
                f"      Anthropic: {'✅' if anthropic_result.get('success') else '❌'}"
            )
            return False
...
if __name__ == "__main__":
    print(
        "🚀 Starting Mistral Complete Tool Chain Test with Universal Compatibility..."
    )
    asyncio.run(main())
