...
async def test_gpt5_manually():
    ...
    try:
            ...
            try:
                ...
                reasoning_response = await client.chat.completions.create(
                    ...
                    messages=[
                        {
                            "role": "user",
                            "content": "If Alice has 3 apples and Bob has twice as many, how many do they have total?",
                        }
                    ],
                ...
                shows_work = any(
                    word in reasoning_text.lower() for word in ["twice", "6", "3"]
                )
        ...
        print("\n📊 MANUAL TEST SUMMARY:")
        print("   This test bypasses chuk_llm and uses OpenAI API directly")
        print("   If models work here but not in chuk_llm, the issue is in the client")
