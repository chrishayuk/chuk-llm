...
async def test_raw_gemini_comprehensive(api_key, messages, tools):
    ...
    try:
        ...
        gemini_tool = gtypes.Tool(function_declarations=function_declarations) if function_declarations else None
...
async def test_duplication_specifically_gemini():
    ...
    messages = [{"role": "user", "content": "Call test_gemini_tool with message 'hello gemini' and count 456"}]
