...
class ToolSimulator:
    ...
    def execute(name: str, args: dict) -> str:
        ...
        if name == "get_weather":
            ...
            temps = {"Tokyo": 18, "New York": 12, "Paris": 15, "London": 10, "Sydney": 25}
            ...
            if "config" in filepath:
                return '{"database": "production", "port": 5432, "host": "db.example.com"}'
...
async def run_scenario(name: str, prompt: str, tools: list, scenario_num: int, total: int):
    ...
    try:
        ...
        if tool_calls:
            tools_used = list(set(tc["function"]["name"] for tc in tool_calls))
            print(f"   • Tools used: {', '.join(tools_used)}")
            print(f"   ✅ Success: Task completed with tools")
        else:
...
async def main():
                    ...
                    "function": {
                        ...
                        "parameters": {
                            ...
                            "properties": {
                                ...
                                "date": {"type": "string", "description": "Meeting date/time"},
    ...
    if successful == total:
        print(f"🎉 Perfect score! All scenarios completed successfully.")
    elif successful >= total * 0.8:
        print(f"👍 Excellent performance! Most scenarios worked well.")
    elif successful >= total * 0.6:
        print(f"👌 Good performance. Some scenarios need attention.")
    else:
        print(f"⚠️  Needs improvement. Check model configuration.")
